...
study = optuna.create_study(
    ...
    study_name=f"gridsearch_pnpmm_pet_images",
    storage=f"sqlite:///gridsearch_pnpmm_pet_images.db",  # Persist study results
    load_if_exists=True,  # Continue from existing study if available
)
ckpt_path = pathlib.Path(
    "./weights/25-10-13-14:12:28/ckp_best.pth.tar"
)  # Pretrained DnCNN weights
