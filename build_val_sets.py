...
# Should produce 20 validation slices (1 phantom, 4 random rotations each, 5 slices each,...)

phanPath = r"./phantoms/Brainweb"
save_training_dir = r"./MoDL/valDatasets/brainweb/2D"
phanType = "brainweb"
phanNumber = np.arange(10, 11, 1)  # use brainweb phantom 10-11 out of 20
