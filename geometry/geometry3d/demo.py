...
y_batch, AF_batch, _ = PET.simulateSinogramData(
    img_2d_batch, mumap=mumap_2d_batch, counts=1e6, psf=psf_cm
)
...
y3d_batch, AF3d_batch, _ = PET.simulateSinogramData(
    img_3d_batch, mumap=mumap_3d_batch, counts=100e6, psf=psf_cm
)
